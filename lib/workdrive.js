...
/* WorkDrive rejects long link names with 400 F6005 "Parameter length more than
   permitted". Observed failing at 58 chars; 40 leaves headroom. Enforced inside
   createUploadLink so no caller can reintroduce the bug. */
const MAX_LINK_NAME_LENGTH = 40;
  ...
  const payload = {
    data: {
      ...
      attributes: {
        ...
        link_name: linkName.trim().slice(0, MAX_LINK_NAME_LENGTH).trim(),
        role_id: "7",
